...
def PacketHandler(pkt):
    ...
    if pkt.haslayer(Dot11):
        ...
        if pkt.type == 2 and pkt.subtype == 8 and pkt.addr1 == AP_MAC_2:
            ...
            scapy.wrpcap('/home/proyecto/Documentos/pruebaInyeccion/inyeccionTramasSeguras/prueba4/paquetes_recuperados.pcap', packets, append=True)

# Inicializar archivo pcap
scapy.wrpcap('/home/proyecto/Documentos/pruebaInyeccion/inyeccionTramasSeguras/prueba4/paquetes_recuperados.pcap', [])
