...
# Función principal
def main():
    eth_paquetes = leer_datos_paquetes("datosPaquetes15Ray0.0006.txt")
    global ind
    ...
    for paquetes in eth_paquetes:
        ...
        escribir_en_archivo("Tiempo en el aire de la agrupación (calculado con función): " + str(Tpaquete2))
