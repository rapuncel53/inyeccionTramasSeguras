...
def generar_fichero(longitud_media, desviacion_maxima, tiempo, tasa, tipo_norma,proporcion_ocupacion):
    ...
    os.makedirs(f"/home/proyecto/Documentos/pruebaInyeccion/inyeccionTramasSeguras/versionesFinales/v2/datosPaquetes/{longitud_media}_{desviacion_maxima}", exist_ok=True)
    output_file = open(f"/home/proyecto/Documentos/pruebaInyeccion/inyeccionTramasSeguras/versionesFinales/v2/datosPaquetes/{longitud_media}_{desviacion_maxima}/datosPaquetes{longitud_media}_{desviacion_maxima}_{proporcion_ocupacion}.txt", "w")
